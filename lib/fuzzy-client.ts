...
export async function getRecommendations(
  ...
  return {
    outdoorSafety: {
      value: data.outdoor_safety,
      label: data.outdoor_safety_label,
    },
    mask: {
      value: data.mask_recommendation,
      label: data.mask_label,
      type: data.mask_type,
    },
    ...
    ventilation: {
      value: data.ventilation_advice,
      label: data.ventilation_label,
    },
